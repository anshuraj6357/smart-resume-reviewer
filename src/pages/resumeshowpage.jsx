  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 py-12 px-6">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* Privacy Notice */}
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 p-6 flex items-start space-x-4">
          <Shield className="w-6 h-6 text-gray-600 mt-1" />
          <div>
            <h4 className="font-semibold text-gray-900 text-lg">Privacy & Security</h4>
