          ...
          <div className="p-8 space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-6">
              <button
                ...
                className="flex-1 py-3 rounded-2xl bg-blue-600 text-white font-medium hover:bg-blue-700 transition duration-200 disabled:bg-blue-400 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                {isLoading ? (
                  <>
                    <span>Uploading...</span>
              ...
              <button
                ...
                className="flex-1 py-3 rounded-2xl bg-green-600 text-white font-medium hover:bg-green-700 transition duration-200 flex items-center justify-center space-x-2"
              >
                {generateloading ? (
                  <>
